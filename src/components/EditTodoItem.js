const EditTodoItem = (todo) => {
  return `<div class="flex justify-center items-center w-[100%] h-[15%]">
        ...
        <div class="mt-8 flex justify-center w-[100%] h-[50%]">
          <table class="w-[80%]">
            <tr>
              <td class="w-[40%]"><p class="font-bold">📌 내용</p></td>
              <td><input id="editTodoItemContent" type="text" class="outline outline-1 outline-gray-600 rounded px-2" value="${
                todo.content
              }"></input></td>
            </tr>
            <tr>
      ...
      rounded px-2" value="${todo.deadLine}"></input></td>
        ...
        <div class="mt-10 flex justify-center items-center gap-[20%]">
          <button id="updateTodoItem" class="px-3 py-1 bg-black text-white rounded hover:bg-gray-500">완료</button>
